...
An interactive, digital edition of the classic Battleship board game.

🌐 [View Live Demo](https://zoieboyd.github.io/battleship) | 🎨 [View Figma Design Mockup](https://www.figma.com/design/n3p0OgelcK3YRlGbjZDpPw/Battleship?node-id=0-1&t=y8msh8VTJkDlHMmt-1)
...
- Game Screen
    ...
    - Visual attack status (hit, miss and sunk)
- Dynamic game over screen

## Potential Improvements

- Improved responsiveness across mobile and tablet devices
- Player vs. Player option (local and online multiplayer)
- Additional enemy AI difficulty levels
- Win/loss statistics
...
![Setup Screen Preview](screenshots/setup.png)
_Setup Screen Preview_

![Game Screen Preview](screenshots/game-screen.png)
_Game Screen Preview_

![Game Over Screen Preview](screenshots/game-over.png)
_Game Over Screen Preview_

## Credit

- [Explosion Sound Effect](https://freesound.org/people/modusmogulus/sounds/792520/)
- [Bubbles Sound Effect](https://freesound.org/people/modusmogulus/sounds/844819/)

## Assignment Instructions

[Instructions provided by The Odin Project](https://www.theodinproject.com/lessons/node-path-javascript-battleship#project-solution)
